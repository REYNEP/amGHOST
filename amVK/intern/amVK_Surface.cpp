...
amVK_Surface::amVK_Surface(VkSurfaceKHR pS) {
    ...
    amVK_GlobalProps::push_back_amVK_Surface(this);
}

#include "amVK_SwapChain.hh"
amVK_SwapChain* amVK_Presenter::create_SwapChain_interface(void) {
    this->SC = new amVK_SwapChain(this->S, this->D);
    return this->SC;
}

#include "amVK_RenderPass.hh"
amVK_RenderPass* amVK_Presenter::create_RenderPass_interface(void) {
...
amVK_CommandPool* amVK_Presenter::create_CommandPool_interface(void) {
...
void amVK_Presenter::bind_Device(amVK_Device *D) {
    ...
    this->GPU_Index = amVK_GlobalProps::VkPhysicalDevice_2_PD_Index(D->vk_PhysicalDevice);
}
...
void amVK_Surface::GetPhysicalDeviceSurfaceInfo(void) {
    ...
    amVK_2D_GPUs_ImageFMTs.reserve(amVK_GlobalProps::amVK_1D_GPUs.n);
    amVK_1D_GPUs_SurfCAP  .reserve(amVK_GlobalProps::amVK_1D_GPUs.n);
    ...
    REY_Array_LOOP(amVK_GlobalProps::amVK_1D_GPUs, k)
    {
        ...
        uint32_t imageFormatCount = 0;
            ...
            VkResult return_code = vkGetPhysicalDeviceSurfaceFormatsKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->vk_SurfaceKHR, &imageFormatCount, nullptr);
        ...
        k_IMG_FMTs->data = new VkSurfaceFormatKHR[imageFormatCount];
                     return_code = vkGetPhysicalDeviceSurfaceFormatsKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->vk_SurfaceKHR, &k_IMG_FMTs->n, k_IMG_FMTs->data);
        ...
        VkSurfaceCapabilitiesKHR *k_SURF_CAPs = &amVK_1D_GPUs_SurfCAP[k];
                     ...
                     return_code = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->vk_SurfaceKHR, k_SURF_CAPs);
...
void amVK_Surface::GetPhysicalDeviceSurfaceCapabilitiesKHR(void) {
    ...
    REY_Array_LOOP(amVK_GlobalProps::amVK_1D_GPUs, k)
    {
        ...
        VkSurfaceCapabilitiesKHR *k_SURF_CAPs = &amVK_1D_GPUs_SurfCAP[k];
            ...
            VkResult return_code = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->vk_SurfaceKHR, k_SURF_CAPs);
            amVK_return_code_log( "vkGetPhysicalDeviceSurfaceCapabilitiesKHR()" );
