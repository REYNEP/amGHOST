...
void amVK_Surface::GetPhysicalDeviceSurfaceInfo(void) {
    ...
    REY_Array_LOOP(amVK_GlobalProps::amVK_1D_GPUs, k)
    {
        ...
        uint32_t imageFormatCount = 0;
            ...
            VkResult return_code = vkGetPhysicalDeviceSurfaceFormatsKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->S, &imageFormatCount, nullptr);
        ...
        k_IMG_FMTs->data = new VkSurfaceFormatKHR[imageFormatCount];
                     return_code = vkGetPhysicalDeviceSurfaceFormatsKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->S, &k_IMG_FMTs->n, k_IMG_FMTs->data);
        ...
        VkSurfaceCapabilitiesKHR *k_SURF_CAPs = &amVK_1D_GPUs_SurfCAP[k];
                     ...
                     return_code = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->S, k_SURF_CAPs);
...
void amVK_Surface::GetPhysicalDeviceSurfaceCapabilitiesKHR(void) {
    ...
    REY_Array_LOOP(amVK_GlobalProps::amVK_1D_GPUs, k)
    {
        ...
        VkSurfaceCapabilitiesKHR *k_SURF_CAPs = &amVK_1D_GPUs_SurfCAP[k];
            ...
            VkResult return_code = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(amVK_GlobalProps::amVK_1D_GPUs[k], this->S, k_SURF_CAPs);
            amVK_return_code_log( "vkGetPhysicalDeviceSurfaceCapabilitiesKHR()" );
