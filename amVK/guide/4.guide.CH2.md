...
- https://vkdoc.net/man/VkDeviceCreateInfo
    ...
    - `.ppEnabledLayerNames` --> _deprecated [by Vulkan]_
...
- ##### `📽️ So far, The result`:- 
    - [4.guide.chapter2.4.midway.hh](./examples/4.guide.chapter2.4.midway.hh)
...
- ##### `</> TheCode`
    ...
    - `📽️ So far, The result`:- [4.guide.chapter2.5.amVK_Instance.hh](./examples/4.guide.chapter2.5.amVK_Instance.hh)
...
```
- `📽️ So far, The result`:- [4.guide.chapter2.7.TheEnd.hh](./examples/4.guide.chapter2.7.TheEnd.hh)

-------------------------------------------------------------------

#### 10. Organizing stuff into classes....
- `amVK_GlobalProps.hh`
    1. `class amVK_GlobalProps`
        - `amVK_Instance::GetPhysicalDeviceQueueFamilyProperties()`
        - `amVK_Instance::EnumeratePhysicalDevices()`
