...
class amVK_DeviceQueues {
  ...
  public:
    struct amVK_QueueCount {                        /**                  "That's gonna be Queried to vkCreateDevice()"                 */
        ...
        uint32_t    VideoDecode = 0;                /**                          amVK_1D_QFAMs_QCount_Internal                         */
        uint32_t        Compute = 0;
        uint32_t       Transfer = 0;
    ...
    void generate_1D_QFAMs_QCount_Internal(void) {  /**        generate_1D_QCI() calls ---> generate_1D_QFAMs_QCount_Internal()        */
    ...
    static inline VkDeviceQueueCreateInfo s_CI_Template  = {            // see: `generate_1D_QCIs()`
        ...
        //       So, Don't modify           amVK_1D_QCIs     yourself 💁‍♀️             rather add to --> amVK_1D_QFAMs_QCount_USER 
    ...
    void                                generate_1D_QCIs(void);                         // generate_1D_QCI() calls ---> generate_1D_QFAMs_QCount_Internal()
    bool                         called_generate_1D_QCIs = false;
    void                                    sync_1D_QCIs(VkDeviceCreateInfo* DeviceCI); // Use this, instead of manually setting amVK_1D_QCIs into amVK_Device::CI
